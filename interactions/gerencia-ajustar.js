...
const { embedSucesso, embedErro, embedGerencia, embedInventario } = require('../utils/embeds');
const { getCatalogo, getBau, getDb } = require('../utils/db');
const { getDb: getFirebaseDb } = require('../utils/firebase');
...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    for (const linha of linhas) {
      ...
      if (!encontrado) {
        erros.push(`Item não encontrado: **${nome}**`);
      }
    }
